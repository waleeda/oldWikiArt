...
public enum ArtistCategory: String {
    public static let all: [ArtistCategory] =  [ .popular, .female, .recent, .artMovement, .school, .genre, .field, .nation, .centuries, .chronology, .institutions]
    public static let categoriesWith: [ArtistCategory] = [.artMovement, .school, .genre, .field, .nation, .centuries, .institutions]
...
public extension ArtistCategory {
