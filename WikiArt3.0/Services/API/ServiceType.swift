...
typealias PaintingListCompletion = (Result<PaintingList, Error>) -> Void
typealias PaintingSectionCompletion = (Result<[PaintingSection], Error>) -> Void
typealias PaintingDetailsCompletion = (Result<PaintingDetails, Error>) -> Void
typealias ArtistDetailsCompletion = (Result<ArtistDetails, Error>) -> Void
typealias ArtistSectionsCompletion = (Result<ArtistSections, Error>) -> Void
typealias ArtistsListCompletion = (Result<ArtistsList, Error>) -> Void
typealias AutoCompleteCompletion = (Result<[SearchAutoComplete], Error>) -> Void
...
extension ServiceType where Self == Service {
